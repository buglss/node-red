...
RED.editor.codeEditor.monaco = (function() {
    ...
    const knownModules = {
        ...
        "middleware": {package: "node", module: "middleware", path: "node/middleware.d.ts" },
    }
    const defaultServerSideTypes = [ knownModules["node-red-util"], knownModules["node-red-func"], knownModules["globals"], knownModules["console"], knownModules["buffer"], knownModules["timers"], knownModules["util"], knownModules["express"] ];
