...
module.exports = function(RED) {
    ...
    function HTTPIn(n) {
        ...
        if (RED.settings.httpNodeRoot !== false) {
            ...
            var globalMiddleware = node._flow.parent._middleware.map(function(mw) {
                return new Function("req", "res", "next", mw)
            })

            httpMiddleware = [].concat(httpMiddleware, globalMiddleware)
            if(RED.settings.httpNodeMiddleware) {
                if(typeof RED.settings.httpNodeMiddleware === "function" || Array.isArray(RED.settings.httpNodeMiddleware)) {
                    httpMiddleware = [].concat(RED.settings.httpNodeMiddleware);
                }
            }
